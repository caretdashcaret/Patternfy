...
class ObjectLoaderTest(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.new_object = ObjectLoader(file_location)

    def test_load_object(self):
        f_to_vts, edges_to_vts, vts = self.new_object.load_obj()
    ...
    def test_read_obj_file(self):
        vts, faces = self.new_object.read_obj_file()
    ...
    def test_map_faces_to_vts(self):
        ...
        f_to_vts = self.new_object.map_faces_to_vts(test_faces)
    ...
    def test_parse_edges(self):
        test_face = [[1, 9, 3], [4, 10, 3], [6, 11, 3], [5, 12, 3]]
        edges_to_vts = {}
        edges_to_vts = self.new_object.parse_edges(test_face, edges_to_vts)

        expected_edges_to_vts = {(5, 1): [[12, 9]], (6, 5): [[11, 12]], (4, 6): [[10, 11]], (1, 4): [[9, 10]]}
        assert edges_to_vts == expected_edges_to_vts

        test_additional_face = [[5, 90, 3], [1, 120, 3]]
        edges_to_vts = self.new_object.parse_edges(test_additional_face, edges_to_vts)
    ...
    def test_map_edges_to_vts(self):
        ...
        edges_to_vts = self.new_object.map_edges_to_vts(test_faces)
